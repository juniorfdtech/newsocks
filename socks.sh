...
wget https://raw.githubusercontent.com/juniorfdtech/newsocks/master/proxy443.py > /dev/null 2> /dev/null
history -c
fi
...
wget https://raw.githubusercontent.com/juniorfdtech/newsocks/master/proxy80.py > /dev/null 2> /dev/null
history -c
fi
